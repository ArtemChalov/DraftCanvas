...
namespace prmath
{
    public static class PrimMath
    {
        ...
        static public double XoffsetByTan(double heigth, double angle)
        { // Tested
        ...
        static public double YoffsetByTan(double width, double angle)
        { // Tested
        ...
        static public double GetAngleByWidth(double width, double hypotenuse, double x1, double y1, double x2, double y2)
        ...
        /// <param name="y2">Y coordinate of the second point.</param>
        /// <returns>Returns the angle in degrees.</returns>
        static public double GetAngleByHeight(double height, double hypotenuse, double x1, double y1, double x2, double y2)
        { // Tested from -370 to 370 tested
